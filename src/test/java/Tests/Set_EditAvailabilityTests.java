...
public class Set_EditAvailabilityTests extends BaseTest
{
    @Test
    ...
    @Test
    public void VerifyThatWhenClickedOnEditAvailabilityUserNavigatesToEditAppointmentsAndEventsPage() throws InterruptedException {
        String Characters = Utils.printRandomString(6);
        String FirstName = "Sailaja" + Characters;
        String LastName = "Mamillapllai" + Characters;
        String AlphaNumeric = Utils.getAlphaNumericString(6);
        ...
        Utils.WaitForAnElementToExist(driver, editAppointmentPage.EditPageHeadings.get(0));
        Assert.assertTrue(Utils.IsElementDisplayed(driver, editAppointmentPage.EditPageHeadings.get(0)));
    }

    @Test
    public void VerifyThatWhenClickedBackFromEditAvailabilityPageUserShouldNavigateBackToAppointmentsPage() throws InterruptedException {
        String Characters = Utils.printRandomString(6);
        String FirstName = "Sailaja" + Characters;
        String LastName = "Mamillapllai" + Characters;
        String AlphaNumeric = Utils.getAlphaNumericString(6);
        ...
        //Assert.assertTrue(Utils.IsElementDisplayed(driver, .AppointmentsHeading));
    }
}
